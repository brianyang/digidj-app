...
(function(/*! Stitch !*/) {
...
}, "collections/tracks_collection": function(exports, require, module) {(function() {
  var Todo,
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  var HomeView, MainRouter, NewTodoView, StatsView, TodoView, Todos, TodosView, Tracks;
...
}, "models/track_model": function(exports, require, module) {(function() {
  var __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };

  exports.Track = (function(_super) {
  ...
  exports.MainRouter = (function(_super) {
    ...
    MainRouter.prototype.browse = function() {
      app.views.browse.render();
      return app.collections.tracks.fetch();
    };
  ...
  (function() {
    (function() {
      ...
      __out.push('<input id="new-todo" placeholder="enter track name" type="text">\n<div class="ui-tooltip-top">Press Enter to save this task</div>\n');
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/home_tracks_view": function(exports, require, module) {(function() {
  var homeTracksTemplate,
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };

  homeTracksTemplate = require('templates/home_tracks');

  exports.HomeTracksView = (function(_super) {

    __extends(HomeTracksView, _super);

    function HomeTracksView() {
      HomeTracksView.__super__.constructor.apply(this, arguments);
    }

    HomeTracksView.prototype.el = '#home-tracks-view';

    HomeTracksView.prototype.render = function() {
      this.$(this.el).html(homeTracksTemplate());
  ...
  var HomeView, MainRouter, NewTodoView, StatsView, TodoView, Todos, TodosView;
  ...
  if (typeof $ === "undefined" || $ === null) $ = require('jquery');
  ...
  exports.NewTodoView = (function(_super) {
    ...
    NewTodoView.prototype.render = function() {
      this.$(this.el).html(newTodoTemplate());
      return this;
    };
    ...
    NewTodoView.prototype.createOnEnter = function(event) {
      var fetchQuery;
      if (event.keyCode !== $.ui.keyCode.ENTER) return;
      app.collections.todos.create(this.newAttributes());
      fetchQuery = $('#new-todo').val().trim();
      this.$("#new-todo").val('');
      return $.ajax('/spotify/' + fetchQuery, {
        type: 'GET',
        dataType: 'JSON',
        success: function(data, textStatus, jqXHR) {
          var trackAlbum, trackLen;
          ...
          return $('#todos-view li:last-child').append('<em>' + trackLen + '</em');
        }
      });
    };
    ...
    NewTodoView.prototype.execQuery = function() {
      var curQuery;
      curQuery = this.$("input").val();
      console.log(curQuery);
      return $.ajax('/spotify/' + curQuery, {
        type: 'GET',
        dataType: 'JSON',
        success: function(data, textStatus, jqXHR) {
          var num, queryVal, sortedTracks, trackArtists, trackLen, trackLengths, trackNames;
          ...
          for (num = 1; num <= 99; num++) {
            trackNames.push(data.tracks[num].name);
          }
  ...
  */
  ...
  exports.TodoView = (function(_super) {
    ...
    TodoView.prototype.updateOnEnter = function(e) {
      if (e.keyCode === $.ui.keyCode.ENTER) return this.update();
    };
  ...
  exports.TodosView = (function(_super) {
